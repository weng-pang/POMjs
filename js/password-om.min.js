...
function POM_initialSetup() {
    ...
    if (mkPasswordSlider) {
        mkPasswordSlider.value = POM_initLength;
    ...
    document.getElementById('mk-length-field').value = POM_initLength;
